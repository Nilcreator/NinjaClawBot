...
2026-03-13:
- cleaned the repo-root pytest workflow so `uv run pytest -q` now passes from the monorepo root by delegating to each package's own pytest configuration through [workspace_tests/test_workspace.py](/Users/nilcreator/Desktop/0_Projects/Nilcreation/NinjaRobot/Code%20library/NinjaClawbot/workspace_tests/test_workspace.py)
- removed the user-facing `pwm_pio` backend option from `pi5servo` on the current branch because it is still only a placeholder implementation
- added a compatibility guard in [pi5servo/src/pi5servo/cli/_common.py](/Users/nilcreator/Desktop/0_Projects/Nilcreation/NinjaRobot/Code%20library/NinjaClawbot/pi5servo/src/pi5servo/cli/_common.py) so older `servo.json` files that still name `pwm_pio` fail with a clear branch-compatibility message instead of a confusing runtime error
- [pi5servo/src/pi5servo/core/servo.py](/Users/nilcreator/Desktop/0_Projects/Nilcreation/NinjaRobot/Code%20library/NinjaClawbot/pi5servo/src/pi5servo/core/servo.py)
- [pi5servo/src/pi5servo/core/multi_servos.py](/Users/nilcreator/Desktop/0_Projects/Nilcreation/NinjaRobot/Code%20library/NinjaClawbot/pi5servo/src/pi5servo/core/multi_servos.py)
