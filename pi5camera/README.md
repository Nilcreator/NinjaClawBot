...
### Step 1. Prepare the standalone folder

If you already have a standalone `pi5camera` folder:

```bash
cd ~/pi5camera
```

If not, create one from the repository:
...
> recreate `.venv` and lose system-site-packages access to Picamera2.
